                    ...
                    <div class="card-content">
                        <div class="row">
                            ...
                            <div class="col s12">
                                <div class="input-field">
                                    ...
                                    <textarea id="description" name="description" class="materialize-textarea"
                                        style="min-height: 100px;">{{ old('description', $product->description) }}</textarea>
                            ...
                            <div class="col s12" style="margin-top: 20px;">
                                ...
                                <div id="current-image" style="margin-bottom: 20px;">
                                    @if($product->image)
                                        <div style="position: relative; display: inline-block;">
                                            ...
                                            <span
                                                style="position: absolute; bottom: 16px; left: 16px; background: rgba(0,0,0,0.7); color: white; padding: 6px 12px; border-radius: 8px; font-size: 0.85rem;">
                                                Imagen actual
                                            </span>
                                        </div>
                                    @else
                                        <div
                                            style="padding: 40px; background: var(--bg-secondary); border-radius: 12px; text-align: center;">
                                            <i class="material-icons"
                                                style="font-size: 48px; color: var(--text-secondary);">image</i>
                                            <p style="color: var(--text-secondary); margin: 12px 0 0;">Sin imagen</p>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="file-field input-field">
                                    <div class="btn blue waves-effect waves-light">
                                        <span><i class="material-icons left">cloud_upload</i>Cambiar</span>
                ...
                if (this.files && this.files[0]) {
                    ...
                    reader.onload = function (e) {
                        if (previewImg) {
                            ...
                            document.getElementById('current-image').innerHTML = '<img id="preview-img" src="' + e.target.result + '" alt="Preview" style="max-width: 100%; max-height: 300px; border-radius: 12px; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">';
                        }
                    };
